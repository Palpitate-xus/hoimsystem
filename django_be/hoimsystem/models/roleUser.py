...
class patient(models.Model):
  patient_id = models.AutoField()  # 自动递增的病人id
  name = models.CharField(max_length=24)  # 病人姓名
  sex = models.IntegerField(max_length=1)  # 病人性别，0女1男
...
class doctor(models.Model):
  doctor_id = models.AutoField()  # 自动递增的医生id
  name = models.CharField(max_length=24)  # 医生姓名
  sex = models.IntegerField(max_length=1)  # 医生性别，0女1男
