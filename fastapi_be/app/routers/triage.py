...
# 症状关键词 -> 科室名称 映射
TRIAGE_MAP = {
    "内科": ["发烧", "发热", "感冒", "咳嗽", "头痛", "头晕", "恶心", "呕吐", "腹泻", "腹痛", "胃痛", "胸闷", "心悸", "高血压", "糖尿病", "甲亢", "甲减", "过敏", "皮疹", "乏力", "消瘦", "失眠", "焦虑", "抑郁"],
    ...
    "儿科": ["小儿", "婴儿", "幼儿", "新生儿", "儿童", "宝宝", "孩子", "生长发育", "疫苗", "预防接种", "小儿感冒", "小儿发烧", "小儿腹泻", "小儿咳嗽", "小儿皮疹", "小儿过敏", "小儿哮喘", "小儿肺炎", "小儿黄疸"],
    "眼科": ["眼睛", "眼痛", "眼红", "眼痒", "流泪", "视力模糊", "视力下降", "近视", "远视", "散光", "白内障", "青光眼", "结膜炎", "角膜炎", "眼底", "飞蚊症", "干眼症", "麦粒肿", "霰粒肿", "斜视", "弱视"],
    "耳鼻喉科": ["耳朵", "耳痛", "耳鸣", "听力下降", "耳聋", "耳流脓", "中耳炎", "鼻炎", "鼻塞", "流涕", "打喷嚏", "鼻出血", "鼻窦炎", "咽炎", "咽痛", "喉咙痛", "扁桃体炎", "腺样体肥大", "声音嘶哑", "声带", "异物"],
    "口腔科": ["牙齿", "牙痛", "牙疼", "牙龈", "牙龈出血", "蛀牙", "龋齿", "拔牙", "补牙", "根管治疗", "洗牙", "矫正", "正畸", "种植牙", "口腔溃疡", "口臭", "颞下颌关节", "智齿", "牙周病"],
    "皮肤科": ["皮肤", "皮疹", "红斑", "丘疹", "水疱", "脓疱", "瘙痒", "脱皮", "干燥", "湿疹", "荨麻疹", "痤疮", "痘痘", "粉刺", "色斑", "白癜风", "银屑病", "牛皮癣", "脱发", "灰指甲", "疣", "痣", "瘢痕", "纹身"],
    "骨科": ["骨", "关节", "关节疼痛", "关节肿胀", "关节炎", "风湿", "类风湿", "强直", "脊柱炎", "腰椎间盘突出", "颈椎病", "肩周炎", "滑膜炎", "半月板", "韧带", "骨折", "骨裂", "骨质疏松", "骨质增生", "骨刺", "股骨头坏死", "脊柱侧弯"],
    "神经科": ["神经", "头痛", "偏头痛", "头晕", "眩晕", "昏厥", "抽搐", "癫痫", "瘫痪", "麻木", "刺痛", "中风", "脑梗", "脑出血", "脑瘤", "帕金森", "老年痴呆", "阿尔茨海默", "多发性硬化", "肌无力", "面瘫", "三叉神经痛"],
    ...
    "急诊科": ["急", "紧急", "突发", "剧烈疼痛", "大出血", "昏迷", "休克", "呼吸困难", "窒息", "溺水", "触电", "中毒", "车祸", "高处坠落", "心脏骤停", "心梗", "脑梗", "脑出血", "骨折", "烧伤", "烫伤", "异物卡喉"],
