...
@pytest.mark.asyncio
class TestVitalSign:
    async def test_create_vital_sign(self, async_client, seed_data):
        r = await async_client.post("/api/vitalSign/create", headers={"accesstoken": seed_data["admin_user"].username}, json={
...
@pytest.mark.asyncio
class TestLab:
    async def test_create_lab_result(self, async_client, seed_data):
        ...
        # create result
        r = await async_client.post("/api/labResult/create", headers={"accesstoken": seed_data["admin_user"].username}, json={
    ...
    async def test_audit_lab_result(self, async_client, seed_data):
