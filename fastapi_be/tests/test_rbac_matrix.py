...
ENDPOINTS = [
    ...
    ("GET", "/api/navigation/faq", {"admin", "super_admin", "director", "doctor", "nurse", "cashier", "pharmacist", "guide", "patient", "lab_technician", "registrar"}, None, {}),
    ("POST", "/api/navigation/faq/create", {"admin", "super_admin"}, {"question": "如何挂号", "answer": "登录后选择预约挂号"}, {}),
    ("PUT", "/api/navigation/faq/update", {"admin", "super_admin"}, {"faq_id": 1, "answer": "请登录后挂号"}, {}),
    ...
    # purchase.py (getList restricted to admin — contains supplier pricing)
    ("GET", "/api/purchase/getList", {"admin", "super_admin"}, None, {"status": 0}),
