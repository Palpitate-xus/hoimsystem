...
export const asyncRoutes = [
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@/views/admin/navigationManagement.vue"),
        meta: { title: "院内路线管理", permissions: ["admin"] },
      },
      {
...

  {
    ...
    children: [
      ...
      },
      {
        path: "queueProgress",
        name: "QueueProgress",
        component: () => import("@/views/patient/queueProgress.vue"),
        meta: { title: "排队进度", permissions: ["patient"] },
      },
      {
        path: "review",
        name: "Review",
...

  {
    ...
    name: "Doctor",
    alwaysShow: true,
    meta: { title: "医生工作站", icon: "stamp", permissions: ["admin", "doctor", "director"] },
    children: [
      {
        path: "schedule",
        name: "DoctorSchedule",
      ...
      },
      {
        ...
        meta: { title: "病历管理", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "prescription",
        name: "DoctorPrescription",
        component: () => import("@/views/doctor/prescription.vue"),
        meta: { title: "处方管理", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "prescriptionTemplate",
        name: "PrescriptionTemplate",
        component: () => import("@/views/doctor/prescriptionTemplate.vue"),
        meta: { title: "处方模板", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "diagnosisTemplate",
        name: "DiagnosisTemplate",
        component: () => import("@/views/doctor/diagnosisTemplate.vue"),
        meta: { title: "诊断模板", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "labOrder",
        name: "LabOrder",
        component: () => import("@/views/doctor/labOrder.vue"),
        meta: { title: "检查检验申请", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "attendance",
        name: "Attendance",
        component: () => import("@/views/doctor/attendance.vue"),
        meta: { title: "考勤签到", permissions: ["admin", "doctor", "director"] },
      },
      {
        path: "mdt",
        name: "Mdt",
      ...
      },
      {
        ...
        meta: { title: "临床路径", permissions: ["admin", "doctor", "director"] },
      },
    ],
  },

  {
    ...
    name: "Pharmacy",
    alwaysShow: true,
    meta: { title: "药房管理", icon: "box", permissions: ["admin", "pharmacist", "director"] },
    children: [
      {
        path: "pharmaceutical",
        name: "Pharmaceutical",
        component: () => import("@/views/pharmacy/pharmaceutical.vue"),
        meta: { title: "药品管理", permissions: ["admin", "pharmacist", "director"] },
      },
      {
        path: "antibiotic",
        name: "Antibiotic",
        component: () => import("@/views/pharmacy/antibiotic.vue"),
      ...
      },
      {
        ...
        meta: { title: "处方审核与发药", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "stockAlert",
        name: "StockAlert",
        component: () => import("@/views/pharmacy/stockAlert.vue"),
        meta: { title: "库存预警", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "stockCheck",
        name: "StockCheck",
        component: () => import("@/views/pharmacy/stockCheck.vue"),
        meta: { title: "库存盘点", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "inventoryAdjustment",
        name: "InventoryAdjustment",
        component: () => import("@/views/pharmacy/inventoryAdjustment.vue"),
        meta: { title: "库存调整", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "drugDamage",
        name: "DrugDamage",
        component: () => import("@/views/pharmacy/drugDamage.vue"),
        meta: { title: "药品报损", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "dispenseStats",
        name: "DispenseStats",
      ...
      },
      {
        ...
        meta: { title: "处方点评", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "consumable",
        name: "Consumable",
        component: () => import("@/views/pharmacy/consumable.vue"),
        meta: { title: "耗材管理", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "purchase",
        name: "Purchase",
        component: () => import("@/views/pharmacy/purchase.vue"),
        meta: { title: "药品采购", permissions: ["admin", "pharmacist"] },
      },
      {
        path: "adverseReaction",
        name: "AdverseReaction",
        component: () => import("@/views/pharmacy/adverseReaction.vue"),
        meta: { title: "ADR监测", permissions: ["admin", "pharmacist"] },
      },
    ],
  },

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "发票管理", permissions: ["admin", "cashier"] },
      },
      {
      ...
      },
      {
        ...
        meta: { title: "医保与费用控制", permissions: ["admin", "cashier", "director"] },
      },
      {
        path: "dailySettlement",
        name: "DailySettlement",
        component: () => import("@/views/charge/dailySettlement.vue"),
        meta: { title: "日结对账", permissions: ["admin", "cashier"] },
      },
    ],
  },

  {
    ...
    children: [
      ...
      {
        path: "emergencyMedicalRecord",
        name: "EmergencyMedicalRecord",
        component: () => import("@/views/queue/emergencyMedicalRecord.vue"),
        meta: { title: "急诊病历", permissions: ["admin", "doctor", "director"] },
      },
    ],
  },
...

  {
    ...
    name: "VitalSign",
    alwaysShow: true,
    meta: { title: "护士预检", icon: "first-aid-kit", permissions: ["admin", "nurse"] },
    children: [
      {
        path: "vitalSign",
        name: "VitalSignPage",
      ...
      },
      {
        path: "nursingPlan",
        name: "NursingPlan",
        component: () => import("@/views/vitalsign/nursingPlan.vue"),
        meta: { title: "护理计划", permissions: ["admin", "nurse"] },
      },
      {
        path: "criticalCareRecord",
        name: "CriticalCareRecord",
...

  {
    ...
    name: "Lab",
    alwaysShow: true,
    meta: { title: "检验科", icon: "collection", permissions: ["admin", "doctor", "lab_technician"] },
    children: [
      {
        path: "labResult",
        name: "LabResult",
        component: () => import("@/views/lab/labResult.vue"),
        meta: { title: "检查结果录入", permissions: ["admin", "doctor", "lab_technician"] },
      },
      {
        path: "labPackage",
        name: "LabPackage",
...

  {
    ...
    name: "FollowUp",
    alwaysShow: true,
    meta: { title: "复诊随访", icon: "chat-dot-round", permissions: ["admin", "doctor", "director"] },
    children: [
      {
        path: "followUp",
        name: "FollowUpPage",
        component: () => import("@/views/followup/followUp.vue"),
        meta: { title: "随访管理", permissions: ["admin", "doctor", "director"] },
      },
    ],
  },

  {
    ...
    name: "Report",
    alwaysShow: true,
    meta: { title: "报表统计", icon: "trend-charts", permissions: ["admin", "director", "cashier"] },
    children: [
      {
        path: "reports",
        name: "Reports",
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: "病区床位", permissions: ["admin", "nurse"] },
      },
      {
        path: "admission",
        name: "Admission",
        component: () => import("@/views/inpatient/admission.vue"),
        meta: { title: "入院登记", permissions: ["admin", "nurse"] },
      },
      {
        path: "inpatientOrder",
      ...
      },
      {
        path: "injection",
        name: "Injection",
        component: () => import("@/views/inpatient/injection.vue"),
        meta: { title: "注射管理", permissions: ["admin", "doctor", "director", "nurse"] },
      },
      {
        path: "skinTest",
        name: "SkinTest",
        component: () => import("@/views/inpatient/skinTest.vue"),
      ...
      },
      {
        ...
        meta: { title: "住院费用", permissions: ["admin", "cashier"] },
      },
      {
        path: "discharge",
        name: "DischargePage",
        component: () => import("@/views/inpatient/discharge.vue"),
        meta: { title: "出院结算", permissions: ["admin", "nurse"] },
      },
      {
        path: "emr",
        name: "Emr",
      ...
      },
      {
        ...
        component: () => import("@/views/inpatient/medicalRecordHome.vue"),
