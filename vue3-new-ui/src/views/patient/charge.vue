    ...
    <el-card>
      ...
      <el-table :data="paginatedList" v-loading="loading">
        ...
        <el-table-column label="操作" width="120">
          <template #default="{row}">
            <el-button v-if="row.status===0" size="small" type="primary" @click="openPayDialog(row)">缴费</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
import { getChargeList, commitCharge, createPayment, queryPayment, mockPaymentNotify } from "@/api/charge";
